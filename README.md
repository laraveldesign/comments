...
[![Quality Score](https://img.shields.io/scrutinizer/g/laraveldesign/comments.svg?style=flat-square)](https://scrutinizer-ci.com/g/laraveldesign/comments)
...
Adds comment functionality to Laravel projects.
...
``` php
  <livewire:comments  :key="time().$model->id" :model="$model"></livewire:comments>
```
